...
print(unWISE_reduced[unWISE_ID_col])
print(len(set(unWISE_reduced[unWISE_ID_col])))
print(panSTARRS_reduced[panSTARRS_ID_col])
print(len(set(panSTARRS_reduced[panSTARRS_ID_col])))
